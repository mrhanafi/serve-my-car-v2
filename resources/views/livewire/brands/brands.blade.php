                    ...
                    <div class="table-responsive">
                        <table class="table align-middle table-nowrap mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row"><a href="#" class="fw-medium">{{$i++}}</a></th>
                                    <td>{{$brand->name}}</td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#editModal{{$brand->id}}">Edit</a>
                    
                                                <a class="dropdown-item" href="#">Delete</a>
                                            </div>
                                        </div>
                                        <div id="editModal{{$brand->id}}" class="modal fade" tabindex="-1" aria-labelledby="editModalLabel{{$brand->id}}" aria-hidden="true" style="display: none;">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
